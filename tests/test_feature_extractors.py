...
import numpy as np
import pytest
from dummy_feature_extractors import (
    HF_BAD_TEST_CASES,
    HF_TEST_CASES,
    ST_BAD_TEST_CASES,
    ST_TEST_CASES,
...
ALL_FE_VARIANTS = [(SmallHFEmbedderFE, params) for _, params in HF_TEST_CASES] + [
    (SmallSentenceTransformerFE, params) for _, params in ST_TEST_CASES
]

ALL_FE_VARIANTS_IDS = [test_id for test_id, _ in HF_TEST_CASES] + [
